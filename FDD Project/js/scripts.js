...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (joinForm) {
        joinForm.addEventListener('submit', function(e) {
            ...
            const studentId = this.querySelector('input[placeholder="Student ID"]').value;
            const major = this.querySelector('select').value;
            ...
            alert('Thank you for your application! We will get back to you within 48 hours.');
            this.reset();
        });
    }
...
function animateOnScroll() {
    const elements = document.querySelectorAll('.event-card, .blog-card, .resource-card, .committee-member');
